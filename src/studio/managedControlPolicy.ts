...
const IMAGE_GENERATION_POLICY = {
  ...
  image_guidance_scale: essential('conditioningScale'),
  pag_scale: essential('pagScale'),
  pag_adaptive_scale: advanced('pagAdaptiveScale'),
  processing_resolution: essential('processingResolution'),
  match_input_resolution: essential('matchInputResolution'),
  ...
  control_guidance_start: advanced(),
  control_guidance_end: advanced(),
  layers: essential('layers'),
  resolution: essential('width'),
  cfg_normalize: advanced(),
  use_en_prompt: advanced(),
...
export const MANAGED_CONTROL_POLICIES = {
  ...
  promptEnhance: {
    ...
    width: essential('width'),
    height: essential('height'),
    pe_system_prompt: advanced(),
    pe_temperature: advanced(),
    pe_top_p: advanced(),
    state_out: internal(),
  },
  prompt: {
  ...
  normalizeControlVideo: VIDEO_NORMALIZE_POLICY,
  ...
  diffusersPredictMap: {
    ...
    image_contract: internal(),
    image: internal(),
    prediction_kind: internal(),
    seed: essential('seed'),
    num_inference_steps: essential('steps'),
    processing_resolution: essential('processingResolution'),
    match_input_resolution: essential('matchInputResolution'),
    prediction_map: internal(),
    preview_images: internal(),
    width_out: internal(),
    height_out: internal(),
  },
  ...
  diffusersImageLayerDecompose: IMAGE_GENERATION_POLICY,
  ...
  diffusersThreeDPipeline: PIPELINE_POLICY,
  diffusersThreeDGenerate: {
    pipeline: internal(),
    three_d_contract: internal(),
    prompt: essential('prompt'),
    seed: essential('seed'),
    num_inference_steps: essential('steps'),
    guidance_scale: essential('guidanceScale'),
    frame_size: essential('width'),
    video: internal(),
    width_out: internal(),
    height_out: internal(),
    frames_out: internal(),
  },
  speechModel: PIPELINE_POLICY,
  transcribeAudio: {
    model: internal(),
    audio: internal(),
    task: internal(),
    language: essential('speechLanguage'),
    timestamps: essential('speechTimestamps'),
    chunk_length_seconds: essential('speechChunkSeconds'),
    stride_length_seconds: advanced('speechStrideSeconds'),
    transcript: internal(),
    text: internal(),
    segments: internal(),
  ...
  imageOperation: {
    ...
    width: essential(),
    height: essential(),
    resize_width: essential(),
    resize_height: essential(),
    resize_fit_mode: essential(),
    resize_resampling: essential(),
    rows: essential(),
    columns: essential(),
    channel: essential(),
  ...
  audioOperation: {
    ...
    pipeline_class: internal(),
    operation: internal(),
    start_seconds: essential(),
    duration_seconds: essential(),
    target_sample_rate: essential(),
    normalize_peak: essential(),
    boundary_fade_seconds: essential(),
    reference_window_seconds: essential(),
    target_peak_dbfs: essential(),
    max_adjustment_db: essential(),
    output: internal(),
    sample_rate: internal(),
    duration: internal(),
  },
