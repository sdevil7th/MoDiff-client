...
const SPEC_ROLES = new Set<StudioGraphRole>(
  'diffusersQuantization|diffusersRecipe|diffusersImagePipeline|diffusersImageGenerate|loadImage|loadMask|diffusersImageControl|diffusersImageEdit|diffusersImageInpaint|preview|wanPipeline|wanGenerate|videoExport|loadVideo|normalizeVideo'.split(
    '|',
  ) as StudioGraphRole[],
);
