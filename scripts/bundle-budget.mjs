...
// currently about 513.6 KiB after the P3.1 unconditional-image controls; retain
// a sub-KiB ceiling so unrelated growth still
// fails this gate.
const MAX_TOTAL_GZIP_BYTES = 514 * 1024;
